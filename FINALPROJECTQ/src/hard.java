...
public class hard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(175, 222, 207));
        ...
        enterTitle.setText("ENTER FIVE DIGIT NUMBER HERE");
        ...
        attemptsBox.setText("ATTEMPTS LEFT: 7");
        ...
        jPanel3.add(clueArea, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 380, 560, 72));
        ...
        jPanel3.add(hint_label_total, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 340, 72, 34));
        ...
        jPanel3.add(HINTT, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 340, -1, 34));
    ...
    private void guessButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guessButtonActionPerformed
        ...
        if (!isValidGuess(guess)) {
            notice.setText("Invalid guess. "
                + "Please enter a 5-digit number with no repetition.");
            return;
        }
        ...
        if (guess_num >= 100000){
            notice.setText("Invalid guess. "
                + "Please enter a 5-digit number only.");
            return;
        }
    ...
    // Method to generate a random 5-digit number with no repetition
    ...
    private static String generateClues(String guess, String randomNumber, List<Character> unusedDigits) {
        StringBuilder sb = new StringBuilder();
        if(guess.length() < 5){
            return "Please enter exact 5-digits ";
        }
        for (int i = 0; i < 5; i++) {
            char guessDigit = guess.charAt(i);
            char randomDigit = randomNumber.charAt(i);
